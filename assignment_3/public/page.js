...
*/
var page = {}; // container for page realted functions called from app
...
function createTable(rows,cols) {
    ...
    if (typeof(menuTable) == 'object') {
        ...
        console.log("Error: menuTable missing!");
    }
...
function changePage(page)
{
    ...
    //clear the table with blank cells
    clearTable(menuTable);

    var startIdx = (page-1)*records_per_page;
    var rows = menuTable.rows.length;
    // populate table with data starting from index=startIdx
    var idx = startIdx;
